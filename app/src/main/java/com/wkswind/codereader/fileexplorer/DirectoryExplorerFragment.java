...
public class DirectoryExplorerFragment extends ListFragment implements
	...
	public static DirectoryExplorerFragment newInstance(Bundle args){
		DirectoryExplorerFragment fragment = new DirectoryExplorerFragment();
	...
	static class DirectoryLoader extends AsyncTaskLoaderEx<List<File>>{

		public DirectoryLoader(Context context, Bundle extras) {
		...
		protected List<File> loadDataInBackground(Bundle extras) {
			...
			if(file.exists() && file != null){
				if(TextUtils.isEmpty(codeType)){
                    ...
                    File[] folders = file.listFiles((FileFilter) FileFilterUtils.directoryFileFilter());
                    rst = Arrays.asList(folders);
				}
	...
	public Loader<List<File>> onCreateLoader(int id, Bundle args) {
		// TODO Auto-generated method stub
		return new DirectoryLoader(getActivity(), args);
	}
