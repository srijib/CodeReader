...
<application> element:
    ...
    <provider
            android:name="com.wkswind.codereader.database.HistoryContentProvider"
    ...
    */
    ...
    private static final String TABLENAME = HistoryDao.TABLENAME;
    private static final String PK = HistoryDao.Properties.Id
    .columnName;
    ...
    sURIMatcher.addURI(AUTHORITY, BASE_PATH, HISTORY_DIR);
