...
<application> element:
    ...
    <provider
            android:name="com.wkswind.codereader.database.ResultContentProvider"
    ...
    */
    ...
    private static final String TABLENAME = ResultDao.TABLENAME;
    private static final String PK = ResultDao.Properties.Id
    .columnName;

    private static final int RESULT_DIR = 0;
    ...
    sURIMatcher.addURI(AUTHORITY, BASE_PATH, RESULT_DIR);
